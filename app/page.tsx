...
import StickyScrollFeatures from "./2/components/StickyScrollFeatures";
import HeroImage from "./2/components/HeroImage";
  ...
  return (
    <div className="font-sans text-gray-900 antialiased">
      ...
      <main>
        ...
        ================================================================ */}
        <section className="relative z-[30] mx-auto flex max-w-7xl flex-col items-center gap-12 bg-white px-6 py-24 md:flex-row md:gap-16 lg:px-16">
          {/* 좌: 제품 스크린샷 */}
        ...
        ================================================================ */}
        <section className="relative z-[30] bg-[#FAF6EF] px-6 py-24 lg:px-16">
      ...
      {/* ================================================================
          FOOTER
      ================================================================ */}
      <footer className="relative z-[30] border-t border-gray-200 bg-white px-6 py-16 lg:px-16">
        <div className="mx-auto max-w-7xl">
          {/* 상단: 로고 + 링크 그리드 */}
